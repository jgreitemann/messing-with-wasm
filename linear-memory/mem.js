...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'mem.wast';
  var wasmBinaryFile = 'mem.wasm';
  var asmjsCodeFile = 'mem.temp.asm.js';
...
var real__add_42 = asm["_add_42"]; asm["_add_42"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__add_42.apply(null, arguments);
};
...
var _add_42 = Module["_add_42"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_add_42"].apply(null, arguments) };
